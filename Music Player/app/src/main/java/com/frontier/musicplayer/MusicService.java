...
import com.frontier.musicplayer.helpers.MediaButtonIntentReceiver;
import com.frontier.musicplayer.helpers.MusicPlaybackTrack;
import com.frontier.musicplayer.permissions.Nammu;
import com.frontier.musicplayer.provider.MusicPlaybackState;
import com.frontier.musicplayer.provider.RecentStore;
import com.frontier.musicplayer.provider.SongPlayCount;
import com.frontier.musicplayer.utils.Action;
import com.frontier.musicplayer.utils.NavigationUtils;
import com.frontier.musicplayer.utils.PrefDefaults;
import com.frontier.musicplayer.utils.PrefKeys;
import com.frontier.musicplayer.utils.PreferencesUtility;
import com.frontier.musicplayer.utils.TimberUtils;
import com.frontier.musicplayer.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.frontier.musicplayer.playstatechanged";
    public static final String POSITION_CHANGED = "com.frontier.musicplayer.positionchanged";
    public static final String META_CHANGED = "com.frontier.musicplayer.metachanged";
    public static final String QUEUE_CHANGED = "com.frontier.musicplayer.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.frontier.musicplayer.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.frontier.musicplayer.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.frontier.musicplayer.shufflemodechanged";
    public static final String TRACK_ERROR = "com.frontier.musicplayer.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.frontier.musicplayer";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.frontier.musicplayer.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.frontier.musicplayer.togglepause";
    public static final String PAUSE_ACTION = "com.frontier.musicplayer.pause";
    public static final String STOP_ACTION = "com.frontier.musicplayer.stop";
    public static final String PREVIOUS_ACTION = "com.frontier.musicplayer.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.frontier.musicplayer.previous.force";
    public static final String NEXT_ACTION = "fcom.frontier.musicplayer.next";
    public static final String REPEAT_ACTION = "com.frontier.musicplayer.repeat";
    public static final String SHUFFLE_ACTION = "com.frontier.musicplayer.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.frontier.musicplayer.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.frontier.musicplayer.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.frontier.musicplayer.shutdown";
    ...
    /**what to do when an accelerometer is detected*/
    ...
    public void onCreate() {
        ...
        */
        Log.d(TAG, "onCreate()getting default values for the Shake preferences");
...
*/
   /* public static SharedPreferences getSettings(Context context)
    ...
    private void loadPreference(String key)
    {
        ...
        Log.d(TAG, "load latest shaker shared perefence");
        SharedPreferences settings=getSettings(this);
...
//            }
    ...
    {
        Log.d("My message","Sesorchnage detected");
...
/*
    public void performAction(Action action, MusicPlayer receiver)
    {

        Log.d("My message","Perform the required Action");
        switch(action){
