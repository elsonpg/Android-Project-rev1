...
public final class PreferencesUtility {
    ...
    public static final String[] SHAKE_ACTION = {"nothing","playorpause","next"};
    ...
    public static boolean shakeEnabled() {
        return mPreferences.getBoolean(ENABLE_SHAKE, true);
    }

    public static String getShakeAction(){
     return mPreferences.getString(String.valueOf(SHAKE_ACTION),"Nothing");
    }

    public static int getShakeThreshold() {
        return mPreferences.getInt(SHAKE_THRESHOLD, 80);
    }
